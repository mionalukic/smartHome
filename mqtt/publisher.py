"""MQTT Publisher with batch support"""
...
class MQTTPublisher:
    """Thread-safe MQTT publisher with batch support"""
    ...
    def register_topic(self, topic: str, max_queue_size: int = 100):
        """Register a topic for batch publishing"""
    ...
    def publish(self, topic: str, data: Dict[str, Any], use_batch: bool = True) -> bool:
        ...
        Args:
            ...
            use_batch: If True, queue for batch; if False, send immediately
        """
    ...
    def _publish_now(self, topic: str, data: Dict[str, Any]) -> bool:
        """Publish immediately (not batched)"""
        try:
    ...
    def start_batch_publisher(self):
        """Start batch publishing daemon thread"""
        self.running = True
